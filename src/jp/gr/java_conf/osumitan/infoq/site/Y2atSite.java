...
/**
 * アンケートサイト：enq.y2at.com | enq.nstk-4.com
*/
public class Y2atSite extends EnqueteSite {
	...
	public Y2atSite() {
		...
		// ドメインパターン
		super.domainPattern = Pattern.compile("^.*enq\\.(y2at|nstk-4)\\.com.*$");
		// スタートボタンセレクタ
		...
		// 性別回答パス
		super.genderAnswerPath = By.xpath("//label[starts-with(@for,'q') and contains(text(),'男性')]/ancestor::div/span/input[@type='radio']");
		// 年齢質問パス
		super.ageQuestionPath = By.xpath("//div[contains(text(),'あなたの年齢をお知らせください。')]");
		// 年齢回答パス
		super.ageAnswerPath = By.xpath("//label[starts-with(@for,'q') and contains(text(),'40〜49歳')]/ancestor::div/span/input[@type='radio']");
		// 居住地質問パス
		super.residenceQuestionPath = By.xpath("//div[contains(text(),'あなたのお住まいの都道府県をお知らせください。')]");
		// 居住地回答パス
		super.residenceAnswerPath = By.xpath("//select[starts-with(@name,'q')]/option[contains(text(),'千葉県')]");
		// 職業質問パス
		super.jobQuestionPath = By.xpath("//div[contains(text(),'あなたの職業をお知らせください。')]");
		// 職業回答パス
		super.jobAnswerPath = By.xpath("//label[starts-with(@for,'q') and contains(text(),'会社勤務（一般社員）')]/ancestor::div/span/input[@type='radio']");
		// フロート広告クローズボタンセレクタ
